...
- If you need end-to-end image quality predictions (color accuracy, SNR), read [Signal Chain](./signal-chain.md) and [Noise, SNR, and Dynamic Range](./noise-and-snr.md).
