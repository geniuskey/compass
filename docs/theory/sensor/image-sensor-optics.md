...
Use this page as the physical map of the BSI pixel stack: what each component is, where it sits, and what optical effect it creates. Detailed interference math belongs in [Thin Film Optics](/theory/optics/thin-film-optics), periodic wave optics in [Diffraction](/theory/optics/diffraction), QE formulas in [Quantum Efficiency](/theory/sensor/quantum-efficiency), and solver algorithms in [RCWA Explained](/theory/simulation/rcwa-explained) or [FDTD Explained](/theory/simulation/fdtd-explained).
:::
