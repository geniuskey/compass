...
- **[Light Basics (Theory)](/theory/optics/light-basics)** -- A more detailed treatment of electromagnetic wave theory with full mathematical development.
- **[Thin Film Optics](/theory/optics/thin-film-optics)** -- Deep dive into interference and anti-reflection coating design.
- **[Quantum Efficiency](/theory/sensor/quantum-efficiency)** -- The physics of photon-to-electron conversion and QE calculation.
