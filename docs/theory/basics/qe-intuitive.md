...
- **[Theory: Quantum Efficiency](../sensor/quantum-efficiency.md)** — For the full mathematical treatment, including derivations of absorption calculations, spectral averaging, and angular dependence.
- **[Guide: First Simulation](/guide/first-simulation)** — Set up and run your first COMPASS simulation to see QE computed for a real pixel structure.
- **[Theory: RCWA Explained](../simulation/rcwa-explained.md)** — Understand how the RCWA solver works and why it is well suited to periodic pixel structures.
