...
Use this page as the physical map of the BSI pixel stack: what each component is, where it sits, and what optical effect it creates. Detailed interference math belongs in [Thin Film Optics](/theory/thin-film-optics), periodic wave optics in [Diffraction](/theory/diffraction), QE formulas in [Quantum Efficiency](/theory/quantum-efficiency), and solver algorithms in [RCWA Explained](/theory/rcwa-explained) or [FDTD Explained](/theory/fdtd-explained).
:::
