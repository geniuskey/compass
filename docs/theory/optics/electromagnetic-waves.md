...
COMPASS supports both so you can choose the best tool for each problem and cross-validate results. See [RCWA Explained](../simulation/rcwa-explained) and [FDTD Explained](../simulation/fdtd-explained) for details.
