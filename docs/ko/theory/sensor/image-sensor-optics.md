---
title: 이미지 센서 광학
description: BSI CMOS 이미지 센서 광학 스택을 마이크로렌즈, CFA, BARL, 실리콘 포토다이오드, DTI, 전파 광학 효과 중심으로 설명합니다.
---

# 이미지 센서 광학

::: tip 선수 지식
[CMOS 이미지 센서란?](/ko/theory/basics/what-is-cmos-sensor) → [픽셀 해부학](/ko/theory/basics/pixel-anatomy) → 이 페이지
:::

이 페이지에서는 COMPASS의 주요 시뮬레이션 대상인 후면 조사(Backside-Illuminated, BSI) CMOS 이미지 센서 픽셀의 광학 구조를 설명합니다.

::: info 이 페이지의 범위
이 페이지는 BSI 픽셀 스택의 물리적 지도입니다. 각 구성 요소가 무엇이고, 어디에 있으며, 어떤 광학 효과를 만드는지를 설명합니다. 자세한 간섭 수식은 [박막 광학](/ko/theory/optics/thin-film-optics), 주기 구조의 파동 광학은 [회절](/ko/theory/optics/diffraction), QE 공식은 [양자 효율](/ko/theory/sensor/quantum-efficiency), 솔버 알고리즘은 [RCWA 설명](/ko/theory/simulation/rcwa-explained) 또는 [FDTD 설명](/ko/theory/simulation/fdtd-explained)에서 다룹니다.
:::
...
이 페이지는 픽셀 스택의 지도입니다. 마이크로렌즈 CRA 보정, CFA 분광 응답, BARL 튜닝, 실리콘 두께, DTI, 각도 응답, 편광 민감도의 설계 트레이드오프는 [픽셀 광학 효과](./pixel-optical-effects.md)에서 이어서 다룹니다. 지표 정의와 후처리 공식은 [양자 효율](./quantum-efficiency.md)에서 다룹니다.
