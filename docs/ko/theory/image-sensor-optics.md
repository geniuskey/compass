...
::: info 이 페이지의 범위
이 페이지는 BSI 픽셀 스택의 물리적 지도입니다. 각 구성 요소가 무엇이고, 어디에 있으며, 어떤 광학 효과를 만드는지를 설명합니다. 자세한 간섭 수식은 [박막 광학](/ko/theory/thin-film-optics), 주기 구조의 파동 광학은 [회절](/ko/theory/diffraction), QE 공식은 [양자 효율](/ko/theory/quantum-efficiency), 솔버 알고리즘은 [RCWA 설명](/ko/theory/rcwa-explained) 또는 [FDTD 설명](/ko/theory/fdtd-explained)에서 다룹니다.
:::
