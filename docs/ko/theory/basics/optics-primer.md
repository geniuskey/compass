---
title: 초보자를 위한 광학 입문
description: CMOS 이미지 센서 시뮬레이션에 필요한 파장, 굴절률, 흡수, 반사, 간섭, 회절, 편광을 초보자용으로 설명합니다.
---
...
| 파장 | 색상 | 실리콘에서의 흡수 깊이 |
|---|---|---|
| 450 nm | 파랑(Blue) | ~0.4 um |
| 550 nm | 초록(Green) | ~1.5 um |
| 650 nm | 빨강(Red) | ~3.5 um |
| 850 nm | 근적외선(Near-IR) | ~19 um |

**흡수 깊이(absorption depth)**는 빛이 대부분(약 63%) 흡수되기까지 실리콘에서 이동해야 하는 거리입니다. 파란빛은 매우 빠르게 -- 실리콘의 처음 0.4 um 내에서 -- 흡수됩니다. 빨간빛은 훨씬 깊이 침투하여 약 3 um이 필요합니다. 근적외선은 더 멀리 이동할 수 있습니다.
...
- **[빛의 기초 (이론)](/ko/theory/optics/light-basics)** -- 완전한 수학적 전개가 포함된 전자기파 이론의 더 상세한 다룸.
- **[박막 광학](/ko/theory/optics/thin-film-optics)** -- 간섭과 반사 방지 코팅 설계에 대한 심층 분석.
- **[양자 효율](/ko/theory/sensor/quantum-efficiency)** -- 광자-전자 변환과 QE 계산의 물리.
- **[첫 번째 시뮬레이션](/ko/guide/first-simulation)** -- 배운 것을 적용하여 실제 COMPASS 시뮬레이션을 실행해 봅니다.
- **[재료 데이터베이스 가이드](/ko/guide/material-database)** -- COMPASS가 모든 물질의 굴절률 데이터를 어떻게 저장하고 조회하는지.
