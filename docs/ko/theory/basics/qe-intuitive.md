---
title: 양자 효율 이해하기
description: 양자 효율을 광자 예산 관점에서 설명하고 파장 의존성, QE 손실 요인, 크로스토크, COMPASS의 QE 계산 흐름을 소개합니다.
---
...
::: info 이 페이지의 범위
이 페이지는 QE를 광자 예산으로 직관적으로 설명합니다. 공식 정의, 흡수 적분, 포인팅 플럭스 방법, 픽셀별 채널 처리는 [양자 효율](../sensor/quantum-efficiency.md)에서 다룹니다.
:::
...
- **[이론: 양자 효율](../sensor/quantum-efficiency.md)** -- 흡수 계산의 유도, 스펙트럼 평균, 각도 의존성 등 완전한 수학적 취급을 위해.
- **[가이드: 첫 번째 시뮬레이션](/ko/guide/first-simulation)** -- 실제 픽셀 구조에 대해 COMPASS 시뮬레이션을 설정하고 실행하여 QE 계산을 직접 확인하기 위해.
- **[이론: RCWA 설명](../simulation/rcwa-explained.md)** -- RCWA 솔버의 작동 원리와 주기적 픽셀 구조에 왜 적합한지 이해하기 위해.
