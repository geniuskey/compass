---
title: 회절과 주기 구조
description: 회절, 주기 격자, 블로흐 모드, 픽셀 피치와 파장의 관계, 푸리에 차수, RCWA 수렴을 이미지 센서 관점에서 설명합니다.
---

# 회절과 주기 구조

::: tip 선수 지식
[픽셀 해부학](/ko/theory/basics/pixel-anatomy) → [빛의 기초](/ko/theory/optics/light-basics) → 이 페이지
:::
