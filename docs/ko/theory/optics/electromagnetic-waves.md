---
title: 전자기파
description: COMPASS 광학 시뮬레이션의 맥스웰 방정식 기초, 평면파, 입사 기하학, 경계 조건, 포인팅 에너지 흐름을 설명합니다.
---

# 전자기파

::: tip 선수 지식
이 페이지를 읽기 전에 [광학 기초 입문](/ko/theory/basics/optics-primer)과 [빛의 기초](/ko/theory/optics/light-basics)를 먼저 읽어보세요.
:::
...
COMPASS는 두 솔버를 모두 지원하므로, 각 문제에 가장 적합한 도구를 선택하고 결과를 상호 검증할 수 있습니다. 자세한 내용은 [RCWA 상세 설명](../simulation/rcwa-explained)과 [FDTD 상세 설명](../simulation/fdtd-explained)을 참조하십시오.
