...
// Simulated grcwa data (RCWA — high absorption, low R/T)
const grcwa = {
  R: [0.0139, 0.0131, 0.0125, 0.0102, 0.0119, 0.0148, 0.0144, 0.0121, 0.0114, 0.0139, 0.0176, 0.0202, 0.0206, 0.0193, 0.0173, 0.0159],
  T: [0.0000, 0.0000, 0.0000, 0.0000, 0.0000, 0.0000, 0.0000, 0.0000, 0.0000, 0.0000, 0.0000, 0.0000, 0.0001, 0.0001, 0.0001, 0.0001],
  A: [0.9861, 0.9869, 0.9875, 0.9898, 0.9881, 0.9852, 0.9856, 0.9879, 0.9886, 0.9861, 0.9824, 0.9797, 0.9793, 0.9807, 0.9826, 0.9840],
}

// Simulated FDTD data (close but slightly different, showing method differences)
const fdtd = {
  R: [0.0210, 0.0185, 0.0195, 0.0170, 0.0160, 0.0200, 0.0190, 0.0175, 0.0155, 0.0180, 0.0220, 0.0250, 0.0260, 0.0240, 0.0215, 0.0195],
  T: [0.0005, 0.0003, 0.0002, 0.0002, 0.0003, 0.0005, 0.0004, 0.0003, 0.0002, 0.0003, 0.0006, 0.0010, 0.0015, 0.0012, 0.0008, 0.0005],
  A: [0.9785, 0.9812, 0.9803, 0.9828, 0.9837, 0.9795, 0.9806, 0.9822, 0.9843, 0.9817, 0.9774, 0.9740, 0.9725, 0.9748, 0.9777, 0.9800],
}

// Cone illumination data (absorption only)
const cone = {
  direct:  [0.9861, 0.9869, 0.9875, 0.9898, 0.9881, 0.9852, 0.9856, 0.9879, 0.9886, 0.9861, 0.9824, 0.9797, 0.9793, 0.9807, 0.9826, 0.9840],
  f2_cra0: [0.9842, 0.9850, 0.9860, 0.9882, 0.9868, 0.9838, 0.9840, 0.9862, 0.9870, 0.9848, 0.9810, 0.9782, 0.9778, 0.9790, 0.9810, 0.9825],
  f2_cra15:[0.9810, 0.9820, 0.9835, 0.9855, 0.9840, 0.9808, 0.9812, 0.9835, 0.9845, 0.9820, 0.9780, 0.9750, 0.9745, 0.9758, 0.9780, 0.9795],
}
