...
// Real grcwa simulation data (RCWA, fourier_order=[3,3], complex128)
const grcwa = {
...
// Real FDTD flaport data (Poynting vector method, grid_spacing=0.04um, 150fs)
// Note: flaport uses real-valued permittivity only — no material absorption modeling.
// R/T/A satisfy energy conservation but are noisy due to soft source limitations.
const fdtd = {
  R: [0.0000, 0.2757, 0.5537, 0.1339, 0.1335, 0.7227, 0.4896, 0.0000, 0.0000, 0.3533, 0.0000, 0.5984, 0.3745, 0.0000, 0.0076, 0.0000],
  T: [0.0306, 0.0899, 0.0323, 0.2258, 0.1034, 0.0226, 0.0368, 0.2363, 0.1626, 0.0964, 0.1002, 0.0112, 0.2905, 0.2966, 0.2497, 0.2729],
  A: [0.9694, 0.6343, 0.4141, 0.6403, 0.7632, 0.2547, 0.4737, 0.7637, 0.8374, 0.5504, 0.8998, 0.3904, 0.3350, 0.7034, 0.7427, 0.7271],
}
