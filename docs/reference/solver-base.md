...
| `grcwa` | `compass.solvers.rcwa.grcwa_solver` | RCWA | JAX/NumPy RCWA. Cross-validation reference. |
| `meent` | `compass.solvers.rcwa.meent_solver` | RCWA | PyTorch/JAX/NumPy backends; analytic eigendecomposition. |
| `fmmax` | `compass.solvers.rcwa.fmmax_solver` | RCWA | JAX FMM with 4 vector formulations. |
